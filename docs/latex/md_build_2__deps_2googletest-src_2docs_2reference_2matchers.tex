...
\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md251}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md251}%
...
Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily testing} namespace unless otherwise noted.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md252}{}\doxysection{\texorpdfstring{Wildcard}{Wildcard}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md252}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md253}{}\doxysection{\texorpdfstring{Generic Comparison}{Generic Comparison}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md253}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_FpMatchers}{}\doxysection{\texorpdfstring{Floating-\/\+Point Matchers}{Floating-\/\+Point Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md254}{}\doxysection{\texorpdfstring{String Matchers}{String Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md254}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md255}{}\doxysection{\texorpdfstring{Container Matchers}{Container Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md255}
...
\item an array passed as a pointer and a count (e.\+g. in {\ttfamily Bar(const T\texorpdfstring{$\ast$}{*} buffer,         int len)} -- see \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}{Multi-\/argument Matchers}{1}).
\end{DoxyEnumerate}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md256}{}\doxysection{\texorpdfstring{Member Matchers}{Member Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md256}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md257}{}\doxysection{\texorpdfstring{Matching the Result of a Function, Functor, or Callback}{Matching the Result of a Function, Functor, or Callback}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md257}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md258}{}\doxysection{\texorpdfstring{Pointer Matchers}{Pointer Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md258}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}{}\doxysection{\texorpdfstring{Multi-\/argument Matchers}{Multi-\/argument Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md259}{}\doxysection{\texorpdfstring{Composite Matchers}{Composite Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md259}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md260}{}\doxysection{\texorpdfstring{Adapters for Matchers}{Adapters for Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md260}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &casts matcher {\ttfamily m} to type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
{\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)}   &\href{../gmock_cook_book.md\#SafeMatcherCast}{\texttt{ safely casts}} matcher {\ttfamily m} to type {\ttfamily \doxylink{classMatcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.    \\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_MatchersAsPredicatesCheat}{}\doxysection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ \doxylink{classMatcher}{Matcher}   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md261}{}\doxysection{\texorpdfstring{Defining Matchers}{Defining Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2matchers_autotoc_md261}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}

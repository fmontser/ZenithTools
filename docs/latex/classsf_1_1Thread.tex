...
\hypertarget{classsf_1_1Thread}{}\label{classsf_1_1Thread}\index{sf::Thread@{sf::Thread}}
...
\begin{center}
\leavevmode
\includegraphics[width=170pt]{classsf_1_1Thread__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=170pt]{classsf_1_1Thread__coll__graph}
\end{center}
\end{figure}
...
{\footnotesize template$<$typename C$>$ }\\\mbox{\hyperlink{classsf_1_1Thread_aa9f473c8cbb078900c62b1fd14a83a34}{Thread}} (void(C\+::\texorpdfstring{$\ast$}{*}function)(), C \texorpdfstring{$\ast$}{*}object)
\begin{DoxyCompactList}\small\item\em Construct the thread from a member function and an object. \end{DoxyCompactList}\item 
\mbox{\hyperlink{classsf_1_1Thread_af77942fc1730af7c31bc4c3a913a9c1d}{\texorpdfstring{$\sim$}{\string~}\+Thread}} ()
...
\Hypertarget{classsf_1_1Thread_a00b88f036de66eb63765f4c12ceb6870}\label{classsf_1_1Thread_a00b88f036de66eb63765f4c12ceb6870} 
{\footnotesize template$<$typename F$>$ }\\{\bfseries Thread} (F functor)
\item 
\Hypertarget{classsf_1_1Thread_a719b2cc067d92d52c35064a49d850a53}\label{classsf_1_1Thread_a719b2cc067d92d52c35064a49d850a53} 
{\footnotesize template$<$typename F, typename A$>$ }\\{\bfseries Thread} (F function, A argument)
\item 
\Hypertarget{classsf_1_1Thread_aa9f473c8cbb078900c62b1fd14a83a34}\label{classsf_1_1Thread_aa9f473c8cbb078900c62b1fd14a83a34} 
{\footnotesize template$<$typename C$>$ }\\{\bfseries Thread} (void(C\+::\texorpdfstring{$\ast$}{*}function)(), C \texorpdfstring{$\ast$}{*}object)
\end{DoxyCompactItemize}
\doxysubsubsection*{Friends}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classsf_1_1Thread_a5ed4f3acfcb44de47de196437c39f9ef}\label{classsf_1_1Thread_a5ed4f3acfcb44de47de196437c39f9ef} 
...
To use a \doxylink{classsf_1_1Thread}{sf\+::\+Thread}, you construct it directly with the function to execute as the entry point of the thread. \doxylink{classsf_1_1Thread}{sf\+::\+Thread} has multiple template constructors, which means that you can use several types of entry points\+: \begin{DoxyItemize}
...
The function argument, if any, is copied in the \doxylink{classsf_1_1Thread}{sf\+::\+Thread} instance, as well as the functor (if the corresponding constructor is used). Class instances, however, are passed by pointer so you must make sure that the object won\textquotesingle{}t be destroyed while the thread is still using it.

The thread ends when its function is terminated. If the owner \doxylink{classsf_1_1Thread}{sf\+::\+Thread} instance is destroyed before the thread is finished, the destructor will wait (see \doxylink{classsf_1_1Thread_a724b1f94c2d54f84280f2f78bde95fa0}{wait()})
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_a4cc65399bbb111cf8132537783b8e96c} 
template$<$typename F$>$ \\
...
\end{DoxyCode}
 Note\+: this does {\itshape not} run the thread, use \doxylink{classsf_1_1Thread_a74f75a9e86e1eb47479496314048b5f6}{launch()}.
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_a719b2cc067d92d52c35064a49d850a53} 
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_aa9f473c8cbb078900c62b1fd14a83a34} 
template$<$typename C$>$ \\
...
\hline
\end{DoxyParams}
\Hypertarget{classsf_1_1Thread_af77942fc1730af7c31bc4c3a913a9c1d}\index{sf::Thread@{sf::Thread}!````~Thread@{\texorpdfstring{$\sim$}{\string~}Thread}}
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_af77942fc1730af7c31bc4c3a913a9c1d} 
...
This destructor calls \doxylink{classsf_1_1Thread_a724b1f94c2d54f84280f2f78bde95fa0}{wait()}, so that the internal thread cannot survive after its \doxylink{classsf_1_1Thread}{sf\+::\+Thread} instance is destroyed. 
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_a74f75a9e86e1eb47479496314048b5f6} 
...
This function starts the entry point passed to the thread\textquotesingle{}s constructor, and returns immediately. After this function returns, the thread\textquotesingle{}s function is running in parallel to the calling code. \Hypertarget{classsf_1_1Thread_ad6b205d4f1ce38b8d44bba0f5501477c}\index{sf::Thread@{sf::Thread}!terminate@{terminate}}
\index{terminate@{terminate}!sf::Thread@{sf::Thread}}
\doxysubsubsection{\texorpdfstring{terminate()}{terminate()}}
{\footnotesize\ttfamily \label{classsf_1_1Thread_ad6b205d4f1ce38b8d44bba0f5501477c} 
...
{\footnotesize\ttfamily \label{classsf_1_1Thread_a724b1f94c2d54f84280f2f78bde95fa0} 
...
\item 
build/\+\_\+deps/sfml-\/src/include/\+SFML/\+System/Thread.\+hpp\item 
build/\+\_\+deps/sfml-\/src/include/\+SFML/\+System/Thread.\+inl\item 
build/\+\_\+deps/sfml-\/src/src/\+SFML/\+System/Thread.\+cpp\end{DoxyCompactItemize}

...
\hypertarget{gtest-type-util_8h_source}{}\label{gtest-type-util_8h_source}\index{build/\_deps/googletest-\/src/googletest/include/gtest/internal/gtest-\/type-\/util.h@{build/\_deps/googletest-\/src/googletest/include/gtest/internal/gtest-\/type-\/util.h}}
...
\DoxyCodeLine{00104\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1None}{None}}\ \{\};}
\DoxyCodeLine{00105\ }
...
\DoxyCodeLine{00119\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel}}\ \{}
\DoxyCodeLine{00120\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00121\ \ \ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel_1_1Bind}{Bind}}\ \{}
...
\DoxyCodeLine{00129\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}\ \{}
\DoxyCodeLine{00130\ \ \ \textcolor{keyword}{using\ }Head\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00131\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}<Tail\_...>;}
\DoxyCodeLine{00132\ \};}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \textcolor{keyword}{template}\ <GTEST\_TEMPLATE\_\ Head\_>}
\DoxyCodeLine{00135\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1Templates}{Templates}}<Head\_>\ \{}
\DoxyCodeLine{00136\ \ \ \textcolor{keyword}{using\ }Head\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1TemplateSel}{TemplateSel<Head\_>}};}
\DoxyCodeLine{00137\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1None}{None}};}
\DoxyCodeLine{00138\ \};}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00142\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}\ \{}
\DoxyCodeLine{00143\ \ \ \textcolor{keyword}{using\ }Head\ =\ Head\_;}
\DoxyCodeLine{00144\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Tail\_...>;}
\DoxyCodeLine{00145\ \};}
\DoxyCodeLine{00146\ }
\DoxyCodeLine{00147\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Head\_>}
\DoxyCodeLine{00148\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Head\_>\ \{}
\DoxyCodeLine{00149\ \ \ \textcolor{keyword}{using\ }Head\ =\ Head\_;}
\DoxyCodeLine{00150\ \ \ \textcolor{keyword}{using\ }Tail\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1None}{None}};}
\DoxyCodeLine{00151\ \};}
\DoxyCodeLine{00152\ }
...
\DoxyCodeLine{00156\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList}}\ \{}
\DoxyCodeLine{00157\ \ \ \textcolor{keyword}{using\ }type\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1Types}{Types}}<Ts...>;}
\DoxyCodeLine{00158\ \};}
\DoxyCodeLine{00159\ }
...
\DoxyCodeLine{00164\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1is__proxy__type__list}{is\_proxy\_type\_list}}<\mbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList}}<Ts...>>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00165\ }
...
\DoxyCodeLine{00170\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtesting_1_1internal_1_1GenerateTypeList}{GenerateTypeList}}\ \{}
...
\DoxyCodeLine{00173\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{ProxyTypeList<T>}}>::type;}
\DoxyCodeLine{00174\ }
...
\DoxyCodeLine{00182\ \textcolor{keyword}{using\ }Types\ =\ \mbox{\hyperlink{structtesting_1_1internal_1_1ProxyTypeList}{internal::ProxyTypeList}}<Ts...>;}
\DoxyCodeLine{00183\ }

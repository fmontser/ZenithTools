...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{ here}}.)\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}{}\doxysubsection{\texorpdfstring{All Expectations Are Sticky (Unless Said Otherwise)}{All Expectations Are Sticky (Unless Said Otherwise)}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}

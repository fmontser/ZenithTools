...
\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}%


This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily \doxylink{gmock_8h_source}{gmock/gmock.\+h}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_macros}{}\doxysection{\texorpdfstring{Macros}{Macros}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\+\_\+\+METHOD}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}{}\doxysubsubsection{\texorpdfstring{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}
{\ttfamily .In\+Sequence(}\texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter {\itshape {\ttfamily sequences...}} is any number of \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}
...
The parameter {\itshape {\ttfamily expectations...}} can be up to five \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} or \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}{2} objects. The mock function call is expected to occur after all of the given expectations.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}{}\doxysubsection{\texorpdfstring{ON\+\_\+\+CALL}{ON\+\_\+\+CALL}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}
...
See details for each modifier clause below.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}{}\doxysubsubsection{\texorpdfstring{With \{\#\+ON\+\_\+\+CALL.\+With\}}{With \{\#\+ON\+\_\+\+CALL.\+With\}}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_classes}{}\doxysection{\texorpdfstring{Classes}{Classes}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}{}\doxysubsection{\texorpdfstring{Nice\+Mock}{Nice\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}{}\doxysubsection{\texorpdfstring{Naggy\+Mock}{Naggy\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1NaggyMock}{testing::NaggyMock}};}
\DoxyCodeLine{...}
...
\doxylink{classMock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily \doxylink{classNaggyMock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{Strict\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{}\doxysubsection{\texorpdfstring{Sequence}{Sequence}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{}\doxysubsection{\texorpdfstring{In\+Sequence}{In\+Sequence}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{}\doxysubsection{\texorpdfstring{Expectation}{Expectation}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}
{\ttfamily \+::testing\+::\+Expectation}

Represents a mock function call expectation as created by \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}{2}\+:
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}{}\doxysubsection{\texorpdfstring{Expectation\+Set}{Expectation\+Set}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}
{\ttfamily \+::testing\+::\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} objects to the set\+:

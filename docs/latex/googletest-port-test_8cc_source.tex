...
\DoxyCodeLine{00136\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1Castable}{Castable}}\ castable(\&converted);}
...
\DoxyCodeLine{00155\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1ConstCastable}{ConstCastable}}\ const\_castable(\&converted);}
...
\DoxyCodeLine{00181\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ConstAndNonConstCastable}{ConstAndNonConstCastable}}\ castable(\&converted,\ \&const\_converted);}
...
\DoxyCodeLine{00188\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1ConstAndNonConstCastable}{ConstAndNonConstCastable}}\ const\_castable(\&converted,\ \&const\_converted);}
...
\DoxyCodeLine{00201\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1To}{To}}\ to\ =\ ::testing::internal::ImplicitCast\_<To>(\&converted);}
...
\DoxyCodeLine{00412\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
\DoxyCodeLine{00413\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}"{}},\ empty.pattern());}
\DoxyCodeLine{00414\ }
\DoxyCodeLine{00415\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ simple(TypeParam(\textcolor{stringliteral}{"{}hello"{}}));}
\DoxyCodeLine{00416\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}hello"{}},\ simple.pattern());}
\DoxyCodeLine{00417\ }
\DoxyCodeLine{00418\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ normal(TypeParam(\textcolor{stringliteral}{"{}.*(\(\backslash\)\(\backslash\)w+)"{}}));}
...
\DoxyCodeLine{00425\ \ \ \ \ \ \ \{\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ invalid(TypeParam(\textcolor{stringliteral}{"{}?"{}}));\ \},}
...
\DoxyCodeLine{00431\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
...
\DoxyCodeLine{00434\ }
\DoxyCodeLine{00435\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ re(TypeParam(\textcolor{stringliteral}{"{}a.*z"{}}));}
...
\DoxyCodeLine{00444\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
...
\DoxyCodeLine{00447\ }
\DoxyCodeLine{00448\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ re(TypeParam(\textcolor{stringliteral}{"{}a.*z"{}}));}
...
\DoxyCodeLine{00867\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00868\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}"{}},\ empty.pattern());}
\DoxyCodeLine{00869\ }
\DoxyCodeLine{00870\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ simple(\textcolor{stringliteral}{"{}hello"{}});}
...
\DoxyCodeLine{00876\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ normal(NULL);\ \},}
\DoxyCodeLine{00877\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}NULL\ is\ not\ a\ valid\ simple\ regular\ expression"{}});}
\DoxyCodeLine{00878\ }
\DoxyCodeLine{00879\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ normal(\textcolor{stringliteral}{"{}.*(\(\backslash\)\(\backslash\)w+"{}});\ \},}
\DoxyCodeLine{00880\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}'('\ is\ unsupported"{}});}
\DoxyCodeLine{00881\ }
\DoxyCodeLine{00882\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ invalid(\textcolor{stringliteral}{"{}\string^?"{}});\ \},}
...
\DoxyCodeLine{00888\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
...
\DoxyCodeLine{00891\ }
\DoxyCodeLine{00892\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ re1(\textcolor{stringliteral}{"{}a"{}});}
\DoxyCodeLine{00893\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}a"{}},\ re1));}
\DoxyCodeLine{00894\ }
\DoxyCodeLine{00895\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
...
\DoxyCodeLine{00904\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
...
\DoxyCodeLine{00907\ }
\DoxyCodeLine{00908\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1internal_1_1RE}{RE}}\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
...
\DoxyCodeLine{00963\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<int>}}\ t1;}
\DoxyCodeLine{00964\ \ \ EXPECT\_EQ(0,\ t1.get());}
\DoxyCodeLine{00965\ }
\DoxyCodeLine{00966\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<void*>}}\ t2;}
...
\DoxyCodeLine{00971\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<int>}}\ t1(123);}
\DoxyCodeLine{00972\ \ \ EXPECT\_EQ(123,\ t1.get());}
\DoxyCodeLine{00973\ }
\DoxyCodeLine{00974\ \ \ \textcolor{keywordtype}{int}\ i\ =\ 0;}
\DoxyCodeLine{00975\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<int*>}}\ t2(\&i);}
...
\DoxyCodeLine{00986\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<NoDefaultContructor>}}\ bar(\mbox{\hyperlink{classtesting_1_1internal_1_1NoDefaultContructor}{NoDefaultContructor}}(\textcolor{stringliteral}{"{}foo"{}}));}
...
\DoxyCodeLine{01026\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01027\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1Mutex}{Mutex}}\ m;}
...
\DoxyCodeLine{01035\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1Mutex}{Mutex}}\ m;}
...
\DoxyCodeLine{01093\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1Mutex}{Mutex}}\ mutex;}
...
\DoxyCodeLine{01125\ \ \ \ \ pair<\mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<std::string>}}*,\ std::string*>\ param)\ \{}
...
\DoxyCodeLine{01130\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<std::string>}}\ thread\_local\_string(\textcolor{stringliteral}{"{}foo"{}});}
...
\DoxyCodeLine{01211\ \};}
\DoxyCodeLine{01212\ }
\DoxyCodeLine{01213\ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<DestructorTracker>}}*\ ThreadParam;}
\DoxyCodeLine{01214\ }
...
\DoxyCodeLine{01223\ }
\DoxyCodeLine{01224\ \ \ \{}
\DoxyCodeLine{01225\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<DestructorTracker>}}\ thread\_local\_tracker;}
...
\DoxyCodeLine{01245\ }
\DoxyCodeLine{01246\ \ \ \{}
\DoxyCodeLine{01247\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<DestructorTracker>}}\ thread\_local\_tracker;}
...
\DoxyCodeLine{01268\ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1ThreadLocal}{ThreadLocal<std::string>}}\ thread\_local\_string;}

...
{\itshape (You may browse this at \href{https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md}{\texttt{ https\+://github.\+com/ocornut/imgui/blob/master/docs/\+EXAMPLES.\+md}} or view this file with any Markdown viewer)}\hypertarget{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md450}{}\doxysubsection{\texorpdfstring{Dear Im\+Gui\+: Examples}{Dear Im\+Gui\+: Examples}}\label{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md450}
...
You can find Windows binaries for some of those example applications at\+: \href{https://www.dearimgui.com/binaries}{\texttt{ https\+://www.\+dearimgui.\+com/binaries}}\hypertarget{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md451}{}\doxysubsubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md451}
...
If you are using any of the backends provided here, you can add the backends/imgui\+\_\+impl\+\_\+xxxx(.cpp,.h) files to your project and use as-\/in. Each imgui\+\_\+impl\+\_\+xxxx.\+cpp file comes with its own individual Changelog, so if you want to update them later it will be easier to catch up with what changed.\hypertarget{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md452}{}\doxysubsubsection{\texorpdfstring{Examples Applications}{Examples Applications}}\label{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md452}
...
\hypertarget{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md453}{}\doxysubsubsection{\texorpdfstring{Miscellaneous}{Miscellaneous}}\label{md_build_2__deps_2imgui-src_2docs_2EXAMPLES_autotoc_md453}
{\bfseries{Building}}

...
{\itshape (You may browse this at \href{https://github.com/ocornut/imgui/blob/master/docs/BACKENDS.md}{\texttt{ https\+://github.\+com/ocornut/imgui/blob/master/docs/\+BACKENDS.\+md}} or view this file with any Markdown viewer)}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md436}{}\doxysubsection{\texorpdfstring{Dear Im\+Gui\+: Backends}{Dear Im\+Gui\+: Backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md436}
...
{\bfseries{Once Dear Im\+Gui is setup and running, run and refer to {\ttfamily Im\+Gui\+::\+Show\+Demo\+Window()} in imgui\+\_\+demo.\+cpp for usage of the end-\/user API.}}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md437}{}\doxysubsubsection{\texorpdfstring{What are backends?}{What are backends?}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md437}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md438}{}\doxysubsubsection{\texorpdfstring{Integrating a backend}{Integrating a backend}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md438}
See "{}\+Getting Started"{} section of \href{https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md}{\texttt{ EXAMPLES.\+MD}} for more details.\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md439}{}\doxysubsubsection{\texorpdfstring{List of backends}{List of backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md439}
...
Emscripten is also supported! The SDL+\+GL, GLFW+\+GL and GLFW+\+Web\+GPU examples are all ready to build and run with Emscripten.\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md440}{}\doxysubsubsection{\texorpdfstring{Backends for third-\/party frameworks, graphics API or other languages}{Backends for third-\/party frameworks, graphics API or other languages}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md440}
See \href{https://github.com/ocornut/imgui/wiki/Bindings}{\texttt{ https\+://github.\+com/ocornut/imgui/wiki/\+Bindings}} for the full list (e.\+g. Adventure Game Studio, Cinder, Cocos2d-\/x, Game Maker Studio2, Godot, LÖ\+VE+\+LUA, Magnum, Monogame, Ogre, open\+Frameworks, Open\+Scene\+Graph, SFML, Sokol, Unity, Unreal Engine and many others).\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md441}{}\doxysubsubsection{\texorpdfstring{Recommended Backends}{Recommended Backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md441}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md442}{}\doxysubsubsection{\texorpdfstring{Using a custom engine?}{Using a custom engine?}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md442}

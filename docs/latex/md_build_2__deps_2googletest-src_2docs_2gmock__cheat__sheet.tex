...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockClass}{}\doxysubsection{\texorpdfstring{Mocking a Normal Class}{Mocking a Normal Class}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockClass}
Given
...
\DoxyCodeLine{\mbox{\hyperlink{classNaggyMock}{NaggyMock<MockFoo>}}\ naggy\_foo;\ \ \ \ \textcolor{comment}{//\ The\ type\ is\ a\ subclass\ of\ MockFoo.}}
\DoxyCodeLine{StrictMock<MockFoo>\ strict\_foo;\ \ \textcolor{comment}{//\ The\ type\ is\ a\ subclass\ of\ MockFoo.}}

\end{DoxyCode}


\{\+: .callout .note\} {\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockTemplate}{}\doxysubsection{\texorpdfstring{Mocking a Class Template}{Mocking a Class Template}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockTemplate}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_UsingMocks}{}\doxysection{\texorpdfstring{Using Mocks in Tests}{Using Mocks in Tests}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_UsingMocks}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}{}\doxysection{\texorpdfstring{Setting Default Actions}{Setting Default Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{ {\ttfamily ON\+\_\+\+CALL}}}. {\ttfamily ON\+\_\+\+CALL} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{ Knowing When to Expect}} for a more detailed discussion.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ExpectCall}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{ {\ttfamily EXPECT\+\_\+\+CALL}}} in the Mocking Reference.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MatcherList}{}\doxysection{\texorpdfstring{Matchers}{Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MatcherList}
See the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2matchers}{Matchers Reference}{0}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ActionList}{}\doxysection{\texorpdfstring{Actions}{Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ActionList}
See the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_CardinalityList}{}\doxysection{\texorpdfstring{Cardinalities}{Cardinalities}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_CardinalityList}

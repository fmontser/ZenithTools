...
\DoxyCodeLine{00184\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ::testing::UnitTest::GetInstance(),\ actual\_to\_skip);}
\DoxyCodeLine{00185\ \ \ \}}
\DoxyCodeLine{00186\ \ \ std::cout\ <<\ ::std::flush;}
\DoxyCodeLine{00187\ \}}
\DoxyCodeLine{00188\ }
\DoxyCodeLine{00189\ GTEST\_API\_\ \mbox{\hyperlink{classtesting_1_1internal_1_1WithoutMatchers}{WithoutMatchers}}\ GetWithoutMatchers()\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classtesting_1_1internal_1_1WithoutMatchers}{WithoutMatchers}}();\ \}}
\DoxyCodeLine{00190\ }
...
\DoxyCodeLine{00203\ \ \ \ \ \ \ \ \ \ :\ *base64\ ==\ c\ ?\ carry}
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ UnBase64Impl(c,\ base64\ +\ 1,\ carry\ +\ 1);}
\DoxyCodeLine{00205\ \}}
\DoxyCodeLine{00206\ }
\DoxyCodeLine{00207\ \textcolor{keyword}{template}\ <\textcolor{keywordtype}{size\_t}...\ I>}
\DoxyCodeLine{00208\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ UnBase64Impl(\mbox{\hyperlink{structtesting_1_1internal_1_1IndexSequence}{IndexSequence<I...>}},}
\DoxyCodeLine{00209\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keyword}{const}\ base64)\ \{}
\DoxyCodeLine{00210\ \ \ \textcolor{keywordflow}{return}\ \{\{UnBase64Impl(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(I),\ base64,\ 0)...\}\};}
\DoxyCodeLine{00211\ \}}
\DoxyCodeLine{00212\ }
\DoxyCodeLine{00213\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ UnBase64(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \textcolor{keyword}{const}\ base64)\ \{}
\DoxyCodeLine{00214\ \ \ \textcolor{keywordflow}{return}\ UnBase64Impl(MakeIndexSequence<256>\{\},\ base64);}
\DoxyCodeLine{00215\ \}}
\DoxyCodeLine{00216\ }
\DoxyCodeLine{00217\ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ \textcolor{keywordtype}{char}\ kBase64[]\ =}
\DoxyCodeLine{00218\ \ \ \ \ \textcolor{stringliteral}{"{}ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"{}};}
\DoxyCodeLine{00219\ \textcolor{keyword}{static}\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ kUnBase64\ =\ UnBase64(kBase64);}
\DoxyCodeLine{00220\ }
\DoxyCodeLine{00221\ \textcolor{keywordtype}{bool}\ Base64Unescape(\textcolor{keyword}{const}\ std::string\&\ encoded,\ std::string*\ decoded)\ \{}
\DoxyCodeLine{00222\ \ \ decoded-\/>clear();}
\DoxyCodeLine{00223\ \ \ \textcolor{keywordtype}{size\_t}\ encoded\_len\ =\ encoded.size();}
\DoxyCodeLine{00224\ \ \ decoded-\/>reserve(3\ *\ (encoded\_len\ /\ 4)\ +\ (encoded\_len\ \%\ 4));}
\DoxyCodeLine{00225\ \ \ \textcolor{keywordtype}{int}\ bit\_pos\ =\ 0;}
\DoxyCodeLine{00226\ \ \ \textcolor{keywordtype}{char}\ dst\ =\ 0;}
\DoxyCodeLine{00227\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ src\ :\ encoded)\ \{}
\DoxyCodeLine{00228\ \ \ \ \ \textcolor{keywordflow}{if}\ (std::isspace(src)\ ||\ src\ ==\ \textcolor{charliteral}{'='})\ \{}
\DoxyCodeLine{00229\ \ \ \ \ \ \ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{00230\ \ \ \ \ \}}
\DoxyCodeLine{00231\ \ \ \ \ \textcolor{keywordtype}{char}\ src\_bin\ =\ kUnBase64[\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(src)];}
\DoxyCodeLine{00232\ \ \ \ \ \textcolor{keywordflow}{if}\ (src\_bin\ >=\ 64)\ \{}
\DoxyCodeLine{00233\ \ \ \ \ \ \ decoded-\/>clear();}
\DoxyCodeLine{00234\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{00235\ \ \ \ \ \}}
\DoxyCodeLine{00236\ \ \ \ \ \textcolor{keywordflow}{if}\ (bit\_pos\ ==\ 0)\ \{}
\DoxyCodeLine{00237\ \ \ \ \ \ \ dst\ |=\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(src\_bin\ <<\ 2);}
\DoxyCodeLine{00238\ \ \ \ \ \ \ bit\_pos\ =\ 6;}
\DoxyCodeLine{00239\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00240\ \ \ \ \ \ \ dst\ |=\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(src\_bin\ >>\ (bit\_pos\ -\/\ 2));}
\DoxyCodeLine{00241\ \ \ \ \ \ \ decoded-\/>push\_back(dst);}
\DoxyCodeLine{00242\ \ \ \ \ \ \ dst\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(src\_bin\ <<\ (10\ -\/\ bit\_pos));}
\DoxyCodeLine{00243\ \ \ \ \ \ \ bit\_pos\ =\ (bit\_pos\ +\ 6)\ \%\ 8;}
\DoxyCodeLine{00244\ \ \ \ \ \}}
\DoxyCodeLine{00245\ \ \ \}}
\DoxyCodeLine{00246\ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};}
\DoxyCodeLine{00247\ \}}
\DoxyCodeLine{00248\ }
\DoxyCodeLine{00249\ \}\ \ \textcolor{comment}{//\ namespace\ internal}}
\DoxyCodeLine{00250\ \}\ \ \textcolor{comment}{//\ namespace\ testing}}

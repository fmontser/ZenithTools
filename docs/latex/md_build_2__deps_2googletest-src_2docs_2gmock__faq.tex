...
If you find yourself needing to perform some action that\textquotesingle{}s not supported by g\+Mock directly, remember that you can define your own actions using \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}{\`{}\+Make\+Action()\`{}}{2} or \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}{\`{}\+Make\+Polymorphic\+Action()\`{}}{2}, or you can write a stub function and invoke it using \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}{\`{}\+Invoke()\`{}}{2}.

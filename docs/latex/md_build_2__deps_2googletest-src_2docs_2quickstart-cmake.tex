...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_build_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md240}{}\doxysection{\texorpdfstring{Set up a project}{Set up a project}}\label{md_build_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md240}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{ CMake Tutorial}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_build_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}

...
\hypertarget{README.md_autotoc_md394}{}\doxysubsubsubsection{\texorpdfstring{Setup}{Setup}}\label{README.md_autotoc_md394}
To build Google\+Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{README.md_autotoc_md395}{}\doxysubsubsection{\texorpdfstring{Build with CMake}{Build with CMake}}\label{README.md_autotoc_md395}
Google\+Test comes with a CMake build script (\href{https://github.com/google/googletest/blob/master/CMakeLists.txt}{\texttt{ CMake\+Lists.\+txt}}) that can be used on a wide range of platforms ("{}\+C"{} stands for cross-\/platform.). If you don\textquotesingle{}t have CMake installed already, you can download it for free from \href{http://www.cmake.org/}{\texttt{ http\+://www.\+cmake.\+org/}}.

CMake works by generating native makefiles or build projects that can be used in the compiler environment of your choice. You can either build Google\+Test as a standalone project or it can be incorporated into an existing CMake build for another project.\hypertarget{README.md_autotoc_md396}{}\doxysubsubsubsection{\texorpdfstring{Standalone CMake Project}{Standalone CMake Project}}\label{README.md_autotoc_md396}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{README.md_autotoc_md397}{}\doxysubsubsubsection{\texorpdfstring{Incorporating Into An Existing CMake Project}{Incorporating Into An Existing CMake Project}}\label{README.md_autotoc_md397}
...
Note that this approach requires CMake 3.\+14 or later due to its use of the {\ttfamily Fetch\+Content\+\_\+\+Make\+Available()} command.\hypertarget{README.md_autotoc_md398}{}\doxysubsubsubsubsection{\texorpdfstring{Visual Studio Dynamic vs Static Runtimes}{Visual Studio Dynamic vs Static Runtimes}}\label{README.md_autotoc_md398}
...
Enabling this option will make gtest link the runtimes dynamically too, and match the project in which it is included.\hypertarget{README.md_autotoc_md399}{}\doxysubsubsubsection{\texorpdfstring{C++ Standard Version}{C++ Standard Version}}\label{README.md_autotoc_md399}
An environment that supports C++11 is required in order to successfully build Google\+Test. One way to ensure this is to specify the standard in the top-\/level project, for example by using the {\ttfamily set(\+CMAKE\+\_\+\+CXX\+\_\+\+STANDARD 11)} command. If this is not feasible, for example in a C project using Google\+Test for validation, then it can be specified by adding it to the options for cmake via the {\ttfamily DCMAKE\+\_\+\+CXX\+\_\+\+FLAGS} option.\hypertarget{README.md_autotoc_md400}{}\doxysubsubsection{\texorpdfstring{Tweaking Google\+Test}{Tweaking Google\+Test}}\label{README.md_autotoc_md400}
...
We list the most frequently used macros below. For a complete list, see file \href{https://github.com/google/googletest/blob/master/googletest/include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{README.md_autotoc_md401}{}\doxysubsubsection{\texorpdfstring{Multi-\/threaded Tests}{Multi-\/threaded Tests}}\label{README.md_autotoc_md401}

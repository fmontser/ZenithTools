...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}{}\doxysubsection{\texorpdfstring{Mocking Non-\/virtual Methods}{Mocking Non-\/virtual Methods}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}
...
\end{longtabu}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}{}\doxysubsection{\texorpdfstring{The Nice, the Strict, and the Naggy}{The Nice, the Strict, and the Naggy}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1NiceMock}{testing::NiceMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1StrictMock}{testing::StrictMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Fake}{Delegating Calls to a Fake}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}{delegating-\/to-\/fake}{2} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example\+:
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}{}\doxysubsection{\texorpdfstring{Combining Matchers}{Combining Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SafeMatcherCast}{}\doxysubsection{\texorpdfstring{Casting Matchers}{Casting Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectOverload}{}\doxysubsection{\texorpdfstring{Selecting Between Overloaded Functions}{Selecting Between Overloaded Functions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectOverload}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1Matcher}{testing::Matcher}};}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(printer,\ Print(\mbox{\hyperlink{classMatcher}{Matcher<int>}}(Lt(5))));\ \ \textcolor{comment}{//\ void\ Print(int);}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{classvector}{vector<int>}}\ v;}
\DoxyCodeLine{...}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}
...
What if you want to validate more than one members at the same time? Remember that there are \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}{2}.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SafeMatcherCast;}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{classMatcher}{Matcher<Foo>}}\ IsFoo(\textcolor{keyword}{const}\ Foo\&\ foo)\ \{}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_CustomMatcherClass}{}\doxysubsection{\texorpdfstring{Defining a Custom Matcher Class}{Defining a Custom Matcher Class}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_CustomMatcherClass}
Most matchers can be simply defined using \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}{the MATCHER\texorpdfstring{$\ast$}{*} macros}{2}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Gt;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{void},\ Foo,\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classvector}{vector<int>}}\&\ numbers),\ (\textcolor{keyword}{override}));}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{classMatcher}{Matcher<int>}}\ expected\_vector2[]\ =\ \{1,\ Gt(2),\ \_,\ 3,\ ...\};}
...
\item The order of elements {\itshape matters} for {\ttfamily Elements\+Are\texorpdfstring{$\ast$}{*}()}. If you are using it with containers whose element order are undefined (e.\+g. {\ttfamily hash\+\_\+map}) you should use {\ttfamily When\+Sorted} around {\ttfamily Elements\+Are}.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1Matcher}{testing::Matcher}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classMatcher}{Matcher<int>}}\ in\_range\ =\ AllOf(Gt(5),\ Le(10));}
\DoxyCodeLine{\ \ ...\ use\ in\_range\ as\ a\ matcher\ in\ multiple\ EXPECT\_CALLs\ ...}

\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}{}\doxysubsection{\texorpdfstring{Matchers must have no side-\/effects}{Matchers must have no side-\/effects}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}
...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_UseOnCall}{}\doxysubsection{\texorpdfstring{Knowing When to Expect}{Knowing When to Expect}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_UseOnCall}
...
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{here}{2}) or {\ttfamily ON\+\_\+\+CALL()}.
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_uninteresting-vs-unexpected}{}\doxysubsection{\texorpdfstring{Understanding Uninteresting vs Unexpected Calls}{Understanding Uninteresting vs Unexpected Calls}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}{2}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_ParameterlessExpectations}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Arguments}{Ignoring Uninteresting Arguments}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SimplerInterfaces}{simpler mock interface}{2} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}{save the values for later verification}{2}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_OrderedCalls}{}\doxysubsection{\texorpdfstring{Expecting Ordered Calls}{Expecting Ordered Calls}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__for__dummies_OrderedCalls}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_PartialOrder}{}\doxysubsection{\texorpdfstring{Expecting Partially Ordered Calls}{Expecting Partially Ordered Calls}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_PartialOrder}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}{}\doxysubsection{\texorpdfstring{Verifying Complex Arguments}{Verifying Complex Arguments}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingSideEffects}{}\doxysubsection{\texorpdfstring{Mocking Side Effects}{Mocking Side Effects}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingSideEffects}
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{classvector}{vector<string>}}\ names\ =\ \{\textcolor{stringliteral}{"{}George"{}},\ \textcolor{stringliteral}{"{}John"{}},\ \textcolor{stringliteral}{"{}Thomas"{}}\};}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1DefaultValue}{testing::DefaultValue}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same "{}later statements take precedence"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}{}\doxysubsection{\texorpdfstring{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectingArgs}{}\doxysubsection{\texorpdfstring{Selecting an Action\textquotesingle{}s Arguments}{Selecting an Action\textquotesingle{}s Arguments}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectingArgs}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::DoAll;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SetArgPointee;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classAction}{Action}}<bool(\textcolor{keywordtype}{int}*)>\ set\_flag\ =\ DoAll(SetArgPointee<0>(5),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Return(\textcolor{keyword}{true}));}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \mbox{\hyperlink{classAction}{Action}}<int()>\ increment\ =\ IncrementCounter(0);}
\DoxyCodeLine{\ \ EXPECT\_CALL(foo,\ DoThis())}
...
If you are not happy with the default action, you can tweak it as usual; see \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}{Setting Default Actions}{1}.
...
And that\textquotesingle{}s that.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}{}\doxysubsection{\texorpdfstring{Using g\+Mock and Threads}{Using g\+Mock and Threads}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}
...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}{}\doxysubsection{\texorpdfstring{Writing New Matchers Quickly}{Writing New Matchers Quickly}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}
\{\+: .callout .warning\} WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}{this section}{2} for more details.
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{classMatcher}{Matcher<int>}}\ DivisibleBy7()\ \{}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}{}\doxysubsection{\texorpdfstring{Writing New Actions}{Writing New Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}
...
Note that we have to pick different suffixes ({\ttfamily \doxylink{classAction}{Action}}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}{}\doxysubsection{\texorpdfstring{Writing New Monomorphic Actions}{Writing New Monomorphic Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1Action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1ActionInterface}{testing::ActionInterface}};}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{classAction}{Action<IncrementMethod>}}\ IncrementArgument()\ \{}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Actions}{Writing New Polymorphic Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}
...
\DoxyCodeLine{\mbox{\hyperlink{classtesting_1_1PolymorphicAction}{PolymorphicAction<Impl>}}\ MakePolymorphicAction(\textcolor{keyword}{const}\ Impl\&\ impl);}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\mbox{\hyperlink{classtesting_1_1PolymorphicAction}{testing::PolymorphicAction}};}
\DoxyCodeLine{}
...
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockFunction}{}\doxysubsection{\texorpdfstring{Mock std\+::function}{Mock std\+::function}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_MockFunction}

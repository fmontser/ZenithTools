...
\hypertarget{Thread_8inl_source}{}\label{Thread_8inl_source}\index{build/\_deps/sfml-\/src/include/SFML/System/Thread.inl@{build/\_deps/sfml-\/src/include/SFML/System/Thread.inl}}
...
\DoxyCodeLine{00028\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structpriv_1_1ThreadFunc}{ThreadFunc}}}
\DoxyCodeLine{00029\ \{}
\DoxyCodeLine{00030\ \ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{structpriv_1_1ThreadFunc}{\string~ThreadFunc}}()\ \{\}}
...
\DoxyCodeLine{00036\ \textcolor{keyword}{struct\ }ThreadFunctor\ :\ \mbox{\hyperlink{structpriv_1_1ThreadFunc}{ThreadFunc}}}
\DoxyCodeLine{00037\ \{}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{struct\ }ThreadFunctorWithArg\ :\ \mbox{\hyperlink{structpriv_1_1ThreadFunc}{ThreadFunc}}}
\DoxyCodeLine{00046\ \{}
...
\DoxyCodeLine{00055\ \textcolor{keyword}{struct\ }ThreadMemberFunc\ :\ \mbox{\hyperlink{structpriv_1_1ThreadFunc}{ThreadFunc}}}
\DoxyCodeLine{00056\ \{}
...
\DoxyCodeLine{00079\ m\_entryPoint(new\ priv::\mbox{\hyperlink{structpriv_1_1ThreadFunctorWithArg}{ThreadFunctorWithArg}}<F,\ A>(function,\ argument))}
\DoxyCodeLine{00080\ \{}
\DoxyCodeLine{00081\ \}}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ }
...
\DoxyCodeLine{00088\ m\_entryPoint(new\ priv::\mbox{\hyperlink{structpriv_1_1ThreadMemberFunc}{ThreadMemberFunc}}<C>(function,\ object))}
\DoxyCodeLine{00089\ \{}
\DoxyCodeLine{00090\ \}}
